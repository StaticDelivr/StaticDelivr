...
import {
  GitBranch, ArrowRight, Copy, Check,
...
const GitLabPage = () => {
  ...
  const convertUrl = useCallback((url: string): string => {
    ...
    if (blobMatch) {
      ...
      return `${cdn}/gl/${user}/${repo}/${branch}/${file}`;
    }
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (inputUrl.length > 20) {
        setError('Please enter a valid GitLab file URL (blob or raw).');
      }
      setOutputUrl('');
    }
  }, [inputUrl, convertUrl]);
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black selection:bg-orange-500/30 font-sans">
      <NextSeo
        title="GitLab to CDN Converter - Production-ready Assets"
        description="Stop using raw GitLab URLs. Turn any GitLab file into a fast, production-ready CDN asset with global delivery and proper caching."
        canonical="https://staticdelivr.com/gitlab"
        openGraph={{
          url: 'https://staticdelivr.com/gitlab',
          title: 'GitLab to CDN Converter - Fast & Reliable | StaticDelivr',
          description: 'The easiest way to serve GitLab files in production. Global edge network, automated caching, and correct MIME types.',
        }}
      />

      <SoftwareAppJsonLd
        name="StaticDelivr GitLab CDN"
        price="0.00"
        priceCurrency="USD"
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <FadeIn>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-xs font-mono text-zinc-600 dark:text-zinc-400 mb-8">
                ...
                <span>$ staticdelivr --gitlab --convert</span>
              </div>
            </FadeIn>
                ...
                <div className="relative group">
                  ...
                  <div className="relative bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-xl overflow-hidden p-2">
                    <div className="flex items-center px-4 py-2">
                      <GitBranch className="w-5 h-5 text-zinc-400 mr-4" />
                      <input
                        type="text"
                        value={inputUrl}
                        onChange={(e) => setInputUrl(e.target.value)}
                        placeholder="https://gitlab.com/user/repo/-/blob/main/style.css"
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <FadeIn delay={0.1}>
                <Link href="/network" className="group block h-full p-8 rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all hover:shadow-lg">
                  ...
                  <div className="text-sm font-medium text-orange-600 dark:text-orange-400 flex items-center mt-auto">
              ...
              <FadeIn delay={0.2}>
                <Link href="/docs/caching-performance" className="group block h-full p-8 rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all hover:shadow-lg">
                  ...
                  <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-2">8-Day Cache</h3>
                  <p className="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed mb-4">
                    GitLab files are cached for 8 days at the edge, providing fast delivery while keeping your content reasonably fresh.
                  </p>
              ...
              <FadeIn delay={0.4}>
                <div className="group block h-full p-8 rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all hover:shadow-lg">
                  <div className="w-12 h-12 rounded-xl bg-red-50 dark:bg-red-900/10 flex items-center justify-center text-red-600 dark:text-red-500 mb-6 group-hover:scale-110 transition-transform">
              ...
              <div className="bg-white dark:bg-zinc-950 rounded-2xl border border-zinc-200 dark:border-zinc-800 overflow-hidden shadow-sm">
                ...
                <div className="p-8 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/30">
                  ...
                  <div className="flex flex-wrap gap-2 text-sm font-mono">
                    ...
                    <span className="px-2 py-1 rounded bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 font-bold">gl</span>
                    <span className="text-zinc-300">/</span>
                  ...
                  <div className="space-y-6">
                    <div>
                      <div className="text-xs font-medium text-zinc-600 dark:text-zinc-400 mb-2 flex items-center gap-2">
                        <GitBranch className="w-3 h-3" /> Input (GitLab)
                      </div>
