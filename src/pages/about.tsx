  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black selection:bg-emerald-500/30 font-sans">
      <NextSeo
        ...
        description="StaticDelivr is a free, fast, and transparent CDN for the open source world. Learn about our mission to build a fairer, faster internet for everyone."
        canonical="https://staticdelivr.com/about"
        openGraph={{
          url: 'https://staticdelivr.com/about',
          title: 'Infrastructure for Open Source - About StaticDelivr',
          description: 'Built by the community, for the community. High-performance delivery with zero tracking and full transparency.',
        }}
      />
