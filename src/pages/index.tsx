        ...
        <div className="rounded-xl overflow-hidden border border-zinc-200 dark:border-zinc-800 bg-zinc-900 shadow-2xl font-mono text-sm max-w-2xl mx-auto">
            ...
            <div className="p-6 space-y-4">
                <div className="flex flex-wrap gap-2 text-zinc-300">
                    <span className="text-emerald-600 font-bold" role="img" aria-label="Command prompt">➜</span>
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <div className="flex flex-wrap justify-center gap-10 md:gap-16 items-center">
                                    ...
                                    <Link
                                        ...
                                        className="opacity-70 hover:opacity-100 hover:scale-105 transition-all duration-300"
                                    >
                                        <Image src="/assets/sponsors/tuta_logo.svg" alt="Tuta" width={140} height={35} className="h-7 md:h-8 w-auto" />
                                    </Link>
                                    <Link
                                        ...
                                        className="opacity-70 hover:opacity-100 hover:scale-105 transition-all duration-300"
                                    >
                                        <Image src="/assets/sponsors/browserstack.svg" alt="BrowserStack" width={140} height={35} className="h-7 md:h-8 w-auto" />
                                    </Link>
                                    <Link
                                        ...
                                        className="opacity-70 hover:opacity-100 hover:scale-105 transition-all duration-300"
                                    >
                                        <Image src="/assets/sponsors/appsignal.svg" alt="AppSignal" width={140} height={35} className="h-7 md:h-8 w-auto" />
                                    </Link>
                                    <Link
                                        href="/sponsors"
